...
```bash
pip install weather_application
```
...
```bash
pip uninstall weather_application
```
...
# Change directory to the weather_application directory
...
folder is located. Then you can remove the symlink named `weather_application` within that folder.
